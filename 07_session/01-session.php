                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        ...
                        <?php
                            ...
                            // jevar_dump($_SESSION);
                        ?>
                        <p>Principe de session: un fichier temporaire appelé session est créé sur le serveur, avec un identifiant unique. Cette session est liée à un internaute. Dans le même temps un cookie est déposé sur le poste de l'internaute avec l'identifiant (au nom PHPSESSID). Ce cookie est détruit lorsque l'on quitte le navigateur.</p>
